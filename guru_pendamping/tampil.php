        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h3 class="m-0 font-weight-bold text-primary">Tabel Data Guru Pendamping</h3>
            </div>
                    ...
                    ?>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><?= $data['password'] ?></td>
                          <td><?= $data['alamat'] ?></td>
                          <td><a href="edit.php?id_gp=<?= $data['id_gp'] ?>" class="btn btn-danger btn-sm"><i class="bi bi-pencil-square"></i></a>
                            <a href="hapus.php?id_gp=<?= $data['id_gp'] ?>" class="btn btn-warning btn-sm"><i class="bi bi-trash3"></i></a>
                          </td>
                        </tr>
                      </tbody>
                    <?php
